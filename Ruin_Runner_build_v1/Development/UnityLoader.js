...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'Ruin_Runner_build_v1.data';
    var REMOTE_PACKAGE_BASE = 'Ruin_Runner_build_v1.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 35660267;
      var PACKAGE_UUID = 'c19c72fa-50fc-4f6b-9df2-17435a1d1da9';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 22508, 0, 0).open('GET', '/globalgamemanagers');
    new DataRequest(22508, 37132, 0, 0).open('GET', '/globalgamemanagers.assets');
    new DataRequest(37132, 79248, 0, 0).open('GET', '/level0');
    new DataRequest(79248, 110220, 0, 0).open('GET', '/level1');
    new DataRequest(110220, 141248, 0, 0).open('GET', '/level2');
    new DataRequest(141248, 142479, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(142479, 147213, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(147213, 21491365, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(21491365, 27587898, 0, 0).open('GET', '/sharedassets0.resource');
    new DataRequest(27587898, 27884190, 0, 0).open('GET', '/sharedassets1.assets');
    new DataRequest(27884190, 32130214, 0, 0).open('GET', '/sharedassets1.resource');
    new DataRequest(32130214, 32156086, 0, 0).open('GET', '/sharedassets2.assets');
    new DataRequest(32156086, 34074542, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(34074542, 35571914, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(35571914, 35632642, 0, 0).open('GET', '/Resources/unity_builtin_extra');
    new DataRequest(35632642, 35660267, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_Ruin_Runner_build_v1.data');

    };
    Module['addRunDependency']('datafile_Ruin_Runner_build_v1.data');
